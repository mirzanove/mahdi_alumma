...
return 	lol = lol.replace(XRegExp("[\\p{Mn}\\u0640\\u200C]", 'gmi'),'').replace(XRegExp("[\\p{S}\\p{P}\\u06E9\\u06DE{}\"'()\\uFD3F\\uFD3E]", 'gmi'), ' ').replace(/\s\s+/gmi, ' ').replace(XRegExp("^\\s+|\\s+$", 'gmi'),"").replace(XRegExp("[أإآ\u0671]", 'gmi'),"ا").replace(XRegExp("\u0629", 'gmi'),"\u0647").replace(XRegExp("\u0624", 'gmi'),"\u0648").replace(XRegExp("\u0626", 'gmi'),"\u0649").replace(/[\u0660\u0661\u0662\u0663\u0664\u0665\u0666\u0667\u0668\u0669]/g, function (m) {
        return {
        '\u0660': '0',
        '\u0661': '1',
		'\u0662': '2',
...
var gsInvalidExpression="الكلمات التي كتبتها ليست تعبيراً صالحاً.";
var gsSearching="يجري الآن البحث...";
var gsCancel="إلغاء";
var gsCanceled="تم الإلغاء";
