...
var n;return 13===e&&(n=this.widget.get(f("KEY_SEARCH_TERM")),n!==t&&this.widget.publish(f("KEY_SEARCH_TERM"),t),this.widget.publish(f("EVT_SEARCH_TERM"),!0),null!=i?i.target:void 0)?i.target.blur():void 0
