...
$(".tabView").hide();
$("#toc").addClass('tabView2');
$(".header_view").hide();
$("#home_header").show();
$("#home").show();
$("#home_but").addClass("ui-btn-active");
$("#home_but").addClass("ui-state-persist");
$("body").trigger('resize');	
}
