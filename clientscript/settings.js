      ...
      if(_isMobile() == mobiletrue) {
       ...
       // alert(wrapper.innerHTML.replace("size\=+0",""));
		...
		var frame1 = document.createElement('iframe');
		   ...
		   if(_isMobile() == mobiletrue) {
			frameDoc.document.write( "<style>.posttext div,.posttext span{line-height: 160%;}a:link {color: #417394;font-weight: bold;text-decoration: none;}a:visited {color: #417394;font-weight: bold;text-decoration: none;}font{font-size:"+jQueryM_v1_4_5('.posttext').css('font-size')+"}.new_qts,.qts_link{color: #000000;text-align: center;background-color: #F5F5DC;padding: 5px;border: solid 1px #000000;}body{background-color :white;}.img_center{color :black;}.page-break{page-break-after: always;}.thread_title,hr,#copyright,.org, .posttop,.tooltip2,.bbcode,.tooltip3,#pagenumbers,.pda,#navbar{display:none;}.bbcode_container{border-left: 1px solid silver;border-right: 2px solid silver;border-bottom: 2px solid silver;border-top: 1px solid silver;}u{text-decoration: none;padding-bottom:4px;border-bottom:solid;}</style>" );
	       }
	       else{
		   frameDoc.document.write( "<style>.posttext div,.posttext span{line-height: 160%;}a:link{color: #417394;font-weight: bold;text-decoration: none;}a:visited {color: #417394;font-weight: bold;text-decoration: none;}font{font-size:"+jQueryD_1_4_2('.posttext').css('font-size')+"}.new_qts,.qts_link{color: #000000;text-align: center;background-color: #F5F5DC;padding: 5px;border: solid 1px #000000;}body{background-color :white;}.img_center{color :black;}.page-break{page-break-after: always;}.thread_title,hr,#copyright,.org, .posttop,.tooltip2,.bbcode,.tooltip3,#pagenumbers,.pda,#navbar{display:none;}.bbcode_container{border-left: 1px solid silver;border-right: 2px solid silver;border-bottom: 2px solid silver;border-top: 1px solid silver;}u{text-decoration: none;padding-bottom:4px;border-bottom:solid;}</style>" );
	       }
