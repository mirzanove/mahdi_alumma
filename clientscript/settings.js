  ...
  if(jQueryM_v1_4_5(this).scrollTop() + jQueryM_v1_4_5(this).innerHeight() >= jQueryM_v1_4_5(this)[0].scrollHeight) {
   ...
   if(isInIFrame==true){
	   ...
	   jQueryM_v1_4_5("a").on('vclick', function(event) {
			 ...
			 //alert(link);
			     if((link.indexOf("file://") == 0)||(link.indexOf("http://localhost") == 0)||(link.indexOf("https://mirzanove.github.io/") == 0)||(link.indexOf("http://bayan-noon.com") == 0)) {
            ...
            else if((link.indexOf("file://") == 0)||(link.indexOf("http://localhost/") == 0)||(link.indexOf("https://mirzanove.github.io/") == 0)||(link.indexOf("http://bayan-noon.com") == 0)){
