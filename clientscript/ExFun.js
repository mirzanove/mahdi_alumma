...
function printDiv2(divID) {
       ...
       // alert(wrapper.innerHTML.replace("size\=+0",""));
		...
		var frame1 = document.createElement('iframe');
		   ...
		   if(_isMobile() == mobiletrue) {
		   frameDoc.document.write( "<link href='../../bookcss/print.css' rel='stylesheet' media='print' type='text/css'>" );
		  ...
		  if (IE <=8) {     
	      frameDoc.document.write('<link type=\"text/css\" rel=stylesheet href=\"../../bookcss/ie876_fixFont.css\"/>');	
	      }
	      else{
	
	      if(_isMobile() == mobiletrue) {
		  
		  frameDoc.document.write('<link type=\"text/css\" rel=stylesheet href=\"../../bookcss/andriod_ios_fixFont.css\"/>');
	      }
	      else{
		   frameDoc.document.write('<link type=\"text/css\" rel=stylesheet href=\"../../bookcss/ff_ch_ie9_edg_fixFont.css\"/>');         	
	      }
	      }
