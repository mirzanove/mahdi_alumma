...
if (_isMobile() == mobiletrue) {
    ...
    function updateh1family(savefont) {
        ...
        if (selector.selectedIndex == 0) {
            ...
            jQueryD_1_4_2('.posttext > div,.posttext > span')
                .css("line-height", "normal");
            jQueryD_1_4_2('#wrapper')
                .css("font-size", "170%");
            jQueryD_1_4_2('.posttext')
                .css("font-size", "120%");
        ...
        if (typeof encryptedMsg != 'undefined') {
            ...
            if (document.getElementById('staticrypt-password')) {
                if (hh == false) {
                    ...
                    passphrase = document.getElementById('staticrypt-password')
                        .value;
            ...
            var decryptedHMAC = CryptoJS.HmacSHA256(encryptedHTML, CryptoJS.SHA256(passphrase)
                    .toString())
                .toString();
            ...
            if (decryptedHMAC !== encryptedHMAC) {
                ...
                jQueryD_1_4_2(".staticrypt-page")
                    .hide();

                if (fontstylelist == true) {

                    jQueryD_1_4_2("#content")
                    ...
                    jQueryD_1_4_2("#content")
                        .html("<div style =\"background-color:#b54b3d;color:white;font-Weight:bold;font-size:100%;text-align:center;padding:4px;\">صـــــفــحــة مشـــــفـــــرة<br><input type=\"checkbox\" id=\"pass3\"> الدخول التلقائي للبيانات المشفرة.. </input></div>" + plainHTML);
    ...
    jQueryD_1_4_2(document)
        .ready(function () {
            ...
            if (typeof encryptedMsg != 'undefined') {
                ...
                jQueryD_1_4_2("#content")
                    .html('<div class="staticrypt-page" dir = "rtl"><div class="staticrypt-form" ><div class="staticrypt-instructions"><p class="staticrypt-title">**موضوع محمي**</p><hr><span>الرجاء مسح كاش المتصفح والمفضلة بعدالإنتهاء من الموسوعة في حال كان جهاز الذي تستخدمه غير شخصي ودخلت الى البيانات المشفرة<span><hr></div><input style= "" autocomplete="on" id="staticrypt-password" type="password" name="password" placeholder="كلمة السر"/><br><input type="checkbox" id="pass"> حفظ كلمة السر.. </input><br><input type="checkbox" id="pass2"> الدخول التلقائي للبيانات المشفرة.. </input><br><button autocomplete="on" type=\'submit\' id ="subment" class="staticrypt-decrypt-button">فك التشفير</button></div></div>');
                ...
                if (lsTest() === true) {
                    ...
                    if (checked) {
                        ...
                        if (document.getElementById('staticrypt-password')) {
                            document.getElementById('staticrypt-password')
                                .value = checked.hexDecode();
                        }
            ...
            jQueryD_1_4_2("#subment")
                .click(function (event) {

                    event.preventDefault();
                    autolog(event, true, document.getElementById('staticrypt-password')
                        .value);
                    return false;
            ...
            jQueryD_1_4_2("#staticrypt-password")
            ...
            if (fontstylelist == true) {
                ...
                jQueryD_1_4_2("#content")
                    .append('<div class="selecth1FontFamily" >تغيير نوع الخط<br><select  id="selecth1FontFamily" name="selectFontFamily" onchange="updateh1family(true);"><option> Lateef </option><option> Serif </option><option> Arial </option></select><div>');
            }
            ...
            jQueryD_1_4_2("a")
                .live("click", function (event) {
                    ...
                    var classname = jQueryD_1_4_2(this)
                        .attr('class');
                    var link = this.href;
					...
					jQueryD_1_4_2(this).attr("target","_heopenit");	
                                ...
                                if (typeof disable_model !== 'undefined') {
                                    ...
                                    if (window.location != window.parent.location) {
                                        ...
                                        jQueryD_1_4_2(".modal")
                                            .show();
                                        jQueryD_1_4_2("#wrapper,body,html")
                                            .css({
                                                'overflow': 'hidden'
                                            });
                                        jQueryD_1_4_2("#img01")
                                        ...
                                        if (window.location == window.parent.location) {
                                            ...
                                            jQueryD_1_4_2("#wrapper")
                                                .animate({
                                                    scrollTop: jQueryD_1_4_2(hh)
                                                        .position()
                                                        .top + jQueryD_1_4_2("#wrapper")
                                                        .scrollTop()
                                                }, 0);

                                        }
                                        jQueryD_1_4_2(hh)
                                            .css("background-color", "#d5dc91");
                        ...
                        if (checkURL(link)) {
                            ...
                            if (classname == 'alpom2 link_off') {
                                ...
                                if (wkchrom) {
                                    event.stopPropagation();
                                    jQueryD_1_4_2(this)
                                        .attr("target", "_heexternal");
                                    var res = jQueryD_1_4_2(this)
                                        .attr("href");
                                    res = res.replace("heexternal://", "");
                                    jQueryD_1_4_2(this)
                                        .attr("href", "heexternal://" + res)
                                        .removeAttr('target');
                                }
    ...
    function loaddsett() {
        ...
        jQueryD_1_4_2(document)
            .ready(function () {
                ...
                var arrEdited = [];
                jQueryD_1_4_2('.imglink')
                    .each(function (i) {
                        jQueryD_1_4_2(this)
                            .attr('id', 'id_' + (i + 1));

                        arrEdited.push({
                            id: jQueryD_1_4_2(this)
                                .attr('id')
                            , href: jQueryD_1_4_2(this)
                                .parent()
                                .children('.hide_external_link')
                                .children('a')
                                .attr('href')
                ...
                jQueryD_1_4_2('.tooltiptext')
                    .remove();
                // jQueryD_1_4_2('.hide_external_link').remove();
                jQueryD_1_4_2('.pagebody')
                    .children(".page-break")
                    .last()
                    .remove();
                ...
                jQueryD_1_4_2('.btn_print')
                    .click(function (event) {
                        ...
                        if (printin_prosses == false) {
                            ...
                            var c = jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .parent()
                                .parent()
                                .children('.posttext');
                            var postID = jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .parent()
                                .attr("id");
                ...
                jQueryD_1_4_2(document)
                    .click(function (event) {
                        ...
                        if (event.which == 0 || event.which == 1) { //right click
                            ...
                            matches = jQueryD_1_4_2(event.target)
                                .is(".dropbtn")

                            //alert(jQueryD_1_4_2(event.target).is( ".dropbtn" ));
                            if (!matches) {

                                jQueryD_1_4_2('#myDropdown')
                                    .removeClass("show");
                            }
                            ...
                            if (link_disable == false) {
                                jQueryD_1_4_2('.image_custom')
                                    .remove();
                                jQueryD_1_4_2(".link_img")
                                    .remove();
                                jQueryD_1_4_2(".extImag")
                                    .remove();
                                jQueryD_1_4_2(".tooltiptext_custom")
                                    .remove();
                                jQueryD_1_4_2(".tooltiptext_custom_copy")
                                    .remove();
                                jQueryD_1_4_2('.tooltiptext')
                                    .hide();
                                jQueryD_1_4_2('.tooltiptext2')
                                    .hide();
                                jQueryD_1_4_2('.tooltiptext3')
                                    .hide();
                                jQueryD_1_4_2('.tooltiptext4')
                                    .hide();
                                jQueryD_1_4_2('.tooltiptext5')
                                    .hide();
                                jQueryD_1_4_2('.hide_external_link')
                                    .hide();
                                jQueryD_1_4_2('.hide_local_link')
                                    .hide();
                                jQueryD_1_4_2(".moveoff")
                                    .unbind("click");
                                jQueryD_1_4_2(".selected")
                                    .attr("class", 'selected enableselect');
                            }
                ...
                jQueryD_1_4_2(".link_pic")
                    .click(function (event) {
                        ...
                        if (!jQueryD_1_4_2(event.currentTarget)
                            .children(".selected")
                            .hasClass("moveoff")) {
                            jQueryD_1_4_2(".selected")
                                .unbind("click");
                            jQueryD_1_4_2(".selected")
                                .attr("class", 'selected enableselect');
                            jQueryD_1_4_2(event.currentTarget)
                                .children(".selected")
                                .attr("class", 'selected moveoff enableselect');
                            jQueryD_1_4_2(event.currentTarget)
                                .children(".selected")
                                .unbind('click')
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .append('<div class="extImag"><div class="extImag2"><a target="_blank" href=""><img class="img2" src="" height="200" width="200" alt=""></a></div><br><div class="extImag_go linkstyle"><a href="" target="_blank" >الذهاب الى الرابط</a></div><br><div class="extImag_copy linkstyle">نسخ الرابط</div></div>');
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            ...
                            .children('.extImag2')
                            .children('a')
                            .attr("href", jQueryD_1_4_2(event.currentTarget)
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            ...
                            .children('a')
                            .children('img')
                            .attr("src", '../../clientscript/images/loading.gif');
                        ...
                        img.onerror = img.onabort = function () {
                            jQueryD_1_4_2(event.currentTarget)
                                ...
                                .children('a')
                                .children('img')
                                .attr("src", '../../clientscript/images/linklost.jpg');
                            jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .children(".extImag")
                                .children('.extImag2')
                        ...
                        img.src = jQueryD_1_4_2(event.currentTarget)
                            .children(".NOTselected")
                            .children('a')
                            .attr('href');
                        //alert(img.src);
                        ...
                        if (window.location == window.parent.location) {
                            jQueryD_1_4_2("body,html")
                                .scrollTop(jQueryD_1_4_2(this)
                                    .position()
                                    .top);
                        } else {
                            jQueryD_1_4_2("#wrapper")
                ...
                jQueryD_1_4_2(".link_org")
                    .click(function (event) {
                        ...
                        if (jQueryD_1_4_2(".tooltiptext_custom")
                            .length == 0) {
                            jQueryD_1_4_2(event.currentTarget)
                                .append('<div class="tooltiptext_custom"><div class="tooltiptext_custom_go linkstyle"><a href="" target="_blank" >الذهاب الى الرابط</a></div><br><div class="tooltiptext_custom_copy linkstyle">نسخ الرابط</div></div>');
                            jQueryD_1_4_2(event.currentTarget)
                                .children(".tooltiptext_custom")
                                .children(".tooltiptext_custom_go")
                                .children('a')
                                .attr("href", jQueryD_1_4_2(event.currentTarget)
                                    .children('.link_org2')
                                    .attr('href'));
                            ...
                            jQueryD_1_4_2(".tooltiptext_custom_go > a")
                                .click(function (event) {
                                    event.stopPropagation();
                                    //link_img_show = true;
                ...
                jQueryD_1_4_2(".imglink")
                    .click(function (event) {
                        ...
                        if (jQueryD_1_4_2(".link_img")
                            .length == 0) {
                            for (var i = 0; i < arrEdited.length; i++) {

                                if (jQueryD_1_4_2(event.currentTarget)
                                    .attr('id') == arrEdited[i].id) {
                                    jQueryD_1_4_2(event.currentTarget)
                                        .parent()
                                        .append('<span class="link_img"><a target="_blank" href=""><img style="text-align: center; overflow-wrap: break-word; -ms-word-break: break-all; word-break: break-word; word-break: break-all; word-wrap:break-word; direction: rtl;outline: none;border-radius: 6px;color: #ffffff;background-color: #2b7b91;padding: 10px; margin: 5px;" class="cool" src="" height="200" width="200" alt=""></a><br></span>');
                                    jQueryD_1_4_2(event.currentTarget)
                                        .parent()
                                        .children(".link_img")
                                        .children('a')
                                        .attr("href", arrEdited[i].href);
                                    jQueryD_1_4_2(event.currentTarget)
                                        .parent()
                                        .children(".link_img")
                                        .children('a')
                                        .children('img')
                                        .attr("src", arrEdited[i].href)
                                        .click(function (event) {
                        ...
                        if (jQueryD_1_4_2(".image_custom")
                            .length == 0) {
                            jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .append('<span class="image_custom"><a href="" target="_blank" style="text-align: center; overflow-wrap: break-word; -ms-word-break: break-all; word-break: break-word; word-break: break-all; word-wrap:break-word; direction: rtl;outline: none;border-radius: 6px;color: #ffffff;background-color: #2b7b91;padding: 5px 5px;">رابط الصورة في الموقع</a><br></span>');
                            jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .children('.image_custom')
                                .children('a')
                                .attr("href", jQueryD_1_4_2(event.currentTarget)
                                    .children('.hide_param')
                                    .attr('href'))
                ...
                jQueryD_1_4_2("a.threadinfo")
                    .click(function (event) {
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .children('.tooltiptext3')
                            .show()
                            .selectText();
                    });
                jQueryD_1_4_2("a.threadinfo2")
                    .click(function (event) {
                        event.preventDefault();
                        event.stopPropagation();
                        if (typeof disable_model !== 'undefined') {
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .children('.tooltiptext4')
                            .show()
                            .selectText();
                    });
                jQueryD_1_4_2("a.postinfo")
                    .click(function (event) {
                        event.preventDefault();
                        event.stopPropagation();
                        if (typeof disable_model !== 'undefined') {
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .children('.tooltiptext2')
                            .show()
                            .selectText();
                    });

                jQueryD_1_4_2(".txt_resize")
                ...
                jQueryD_1_4_2(".txt_resize")
                    .click(function (event) {
                        ...
                        jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .children('.tooltiptext5')
                            .show();
                    });


                // reset 
                jQueryD_1_4_2(".resetMe")
                    .click(function (event) {
                        ...
                        if (fontSize2 == null) {
                            var gg = jQueryD_1_4_2('.posttext,li')
                                .css('font-size');

                            if (gg.indexOf("px") !== -1) {

                                fontSize2 = ((parseFloat(jQueryD_1_4_2('.posttext,li')
                                    .css('font-size')) / parseFloat(jQueryD_1_4_2('.post,.pagebody')
                                    .css('font-size'))) * 100);
                ...
                jQueryD_1_4_2(".increase")
                    .click(function (event) {
                        ...
                        if (posttopid == jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .parent()
                            .parent()
                            .parent()
                        ...
                        if (posttopid == null) {
                            posttopid = jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .parent()
                                .parent()
                                .parent()
                        ...
                        if (fontSize == null) {
                            //fontSize = null;
                            //alert("getnewzise");
                            var gg = jQueryD_1_4_2(event.currentTarget)
                                .parent()
                                .parent()
                                .parent()
                                .parent()
                            ...
                            if (gg.indexOf("px") !== -1) {
                                ...
                                fontSize = ((parseFloat(jQueryD_1_4_2(event.currentTarget)
                                    .parent()
                                    .parent()
                                    .parent()
                                    .parent()
                                    .parent()
                                    .children('.posttext')
                                    .css('font-size')) / parseFloat(jQueryD_1_4_2('.post')
                                    .css('font-size'))) * 100);
                ...
                jQueryD_1_4_2(".decrease")
                    .click(function (event) {
                        ...
                        var currentSize = jQueryD_1_4_2(event.currentTarget)
                            .parent()
                            .parent()
                            .parent()
                            .parent()
                    ...
                    .hashchange(function () {
                        ...
                        if (section != null) {
                            ...
                            if (section.indexOf("post") !== -1) {
                                ...
                                if (jQueryD_1_4_2(section)
                                    .position()) {

								
								
								if (window.location == window.parent.location) {
                                                 jQueryD_1_4_2("body,html").animate({ scrollTop:  jQueryD_1_4_2(section).position().top}, 0);
