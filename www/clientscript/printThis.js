...
var newWindow  = gui.Window.open('http://'+location.hostname+':'+location.port+"/print.html", {
    title : 'MyApp',
    show : true,
    frame : true,
	icon:"noon.png"
...
function printt(mode){
        ...
        setTimeout(function() {
            ...
            if (opt.loadCSS) {
                if ($.isArray(opt.loadCSS)) {
                   ...
                   $head.append("<link type='text/css' rel='stylesheet' href='././bookcss/archive_print.css'>");
					alert(location.href)
					if(_isMobile() == mobiletrue) {
   ...
   var afterPrint = function(mode) {
    
	if(onetime == false){
		
		document.getElementById('text').innerHTML="تم الطباعة<br><div class =\"dot\">&#10006<\/div>";
