...
$words = str_replace('"', '', "ويخلق");
$HH = mb_convert_encoding(__DIR__ .'\t-699-p-2.html', 'HTML-ENTITIES', "UTF-8");

$str = file_get_contents_utf8(__DIR__ .'\t-699-p-2.html');


 // file_get_contents($HH);
$maxWords = 7;

echo hit_keys($str,$words,$maxWords,null);
